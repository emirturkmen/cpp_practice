...
// of type `AccountStatus` and returns a `bool`.
    ...
    if (a1 == AccountStatus::guest || a2 == AccountStatus::guest) {
        return false;
    }
    if (a1 == AccountStatus::troll || a2 == AccountStatus::troll) {
...
// account has a strictly higher priority than the second.
    bool has_priority(AccountStatus a1, AccountStatus a2){
        ...
        if (a1 == AccountStatus::troll) return false;
        if (a2 == AccountStatus::troll) return true;
        return a1 > a2;  
    }
